...
export type CreditsFilterChip = {
	key: "status" | "soloVencidas"
	label: string
}
	...
	return (
		<div className="px-6 py-4">
			<div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
				<div>
					<p id="creditos-listado" className="text-xs font-semibold uppercase tracking-wide text-slate-500">
						Listado
					</p>
					<p className="mt-1 text-sm font-semibold text-slate-900">Créditos</p>
