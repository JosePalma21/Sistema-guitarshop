...
const productSchema = z.object({
  ...
  precio: z.number().positive("Debe ser un precio válido"),
  cantidad_stock: z
    .number()
    .int()
...
export default function ProductForm({
  ...
  const {
    ...
    defaultValues: defaultValues ?? {
      ...
      precio: 0,
      cantidad_stock: 0,
      id_proveedor: 0 as any, // se obliga a seleccionar uno
    },
  });
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 pt-2">
      ...
      <div>
        <label className="text-sm font-medium text-slate-800">Precio</label>
        <input
          type="number"
          step="0.01"
