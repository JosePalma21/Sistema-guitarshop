...
export type ComprasFilterChip = {
	key: "fechaDesde" | "fechaHasta" | "proveedor" | "totalMin" | "totalMax"
	label: string
}
...
type Props = {
	...
	filterChips: ComprasFilterChip[]
	onRemoveChip: (key: ComprasFilterChip["key"]) => void
	onClearAllFilters: () => void
}

export function ComprasListHeader(props: Props) {
	return (
		<div className="px-6 py-4">
			<div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
				<div>
					<p id="compras-listado" className="text-xs font-semibold uppercase tracking-wide text-slate-500">
						Listado
					</p>
					<p className="mt-1 text-sm font-semibold text-slate-900">Compras</p>
				...
				<div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-end">
					<div className="relative w-full flex-1 sm:min-w-[300px] md:min-w-[360px] lg:min-w-[420px]">
						...
						<input
							...
							placeholder="Buscar por proveedor, #compra o ID…"
