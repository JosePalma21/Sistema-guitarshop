...
export function SaleInvoiceDocument({ sale }: Props) {
  ...
  return (
    <div className="printable-invoice mx-auto w-full bg-white p-6 text-black font-sans" style={{ maxWidth: '210mm', pageBreakAfter: 'avoid' }}>
      {/* ENCABEZADO */}
